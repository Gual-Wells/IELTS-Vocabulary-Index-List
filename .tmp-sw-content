...
const CACHE_NAME = `${CACHE_PREFIX}v5.0.0-alpha.14-providers-20260913-2`;
const APP_SHELL = new URL('./index.html', sw.location.href).href;
const PRECACHE = [
  './css/provider-runtime.css', './css/v5.0.0.css', './css/v5-query-providers.css', './css/v5-query-provider-polish.css', './js/v3-provider-runtime.js', './js/v3-groq-contracts.js', './js/v3-provider-views.js',
  ...
  './js/v5-version.js', './js/v5-suppression-runtime.js', './js/v5-mirror-runtime.js', './js/v5-mirror3.js', './js/v5-bridge.js', './js/v5-collins-bridge.js', './js/v5-query-providers.js', './js/v5-collins-settings.js', './js/v5-seed-migration.js',
