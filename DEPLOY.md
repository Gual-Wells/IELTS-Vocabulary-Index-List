...
7. 提交：`Replace repository with Vocabulary Index 3.0.1 full source`；
8. Push origin。
...
2. 首次打开时，3.0.1 升级引导可能自动刷新一次，以清除旧应用壳缓存；该过程不删除 IndexedDB；
3. Safari 打开 Pages 地址；
4. 看到更新提示后点击“立即更新”；
5. 完全关闭并重新打开主屏幕 PWA；
6. 检查设置中的版本为 `3.0.1`；
7. 按 `tests/MANUAL_CHECKLIST.md` 验收；
8. 验收通过后导出新的 3.0.1 完整 JSON。
