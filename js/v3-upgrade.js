...
// shell from being mixed with the 4.0.1 runtime during a major content break.
(() => {
  const CACHE_PREFIX = 'gual-vocabulary-index-';
  const EXPECTED_CACHE = `${CACHE_PREFIX}v4.0.1-runtime-convergence-20260808-1`;
  const SESSION_KEY = 'vocabulary-index:cache-bridge:4.0.1';
