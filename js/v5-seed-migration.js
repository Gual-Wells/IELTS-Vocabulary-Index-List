...
/**
 * Reconcile a device snapshot with Seed5 using Seed4 as the common ancestor.
 ...
 */
export function reconcileSeedUpgrade(baseInput, currentInput, targetInput, { toRevision = 5, appliedAt = new Date().toISOString() } = {}) {
