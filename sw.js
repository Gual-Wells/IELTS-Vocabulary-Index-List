...
const CACHE_NAME = `${CACHE_PREFIX}v5.0.0-alpha.14-seed11-word-only-20260912-2`;
...
const PRECACHE = [
  ...
  './js/v5-speech.js', './js/v5-version.js', './js/v5-suppression-runtime.js', './js/v5-mirror-runtime.js', './js/v5-mirror3.js', './js/v5-bridge.js', './js/v5-seed-migration.js',
