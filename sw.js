...
const CACHE_NAME = `${CACHE_PREFIX}v5.0.0-alpha.14-seed10-pwa-icon-v5-20260912-2`;
...
const PRECACHE = [
  ...
  './assets/icons/vix-icon-180-v5.png', './assets/icons/vix-icon-192-v5.png', './assets/icons/vix-icon-512-v5.png',
];
