...
const CACHE_NAME = `${CACHE_PREFIX}v5.0.0-alpha.14-ui-compact-20260913-4`;
...
const PRECACHE = [
  ...
  './js/v5-groq-search.js', './js/v5-version.js', './js/v5-suppression-runtime.js', './js/v5-mirror-runtime.js', './js/v5-mirror3.js', './js/v5-bridge.js', './js/v5-seed-migration.js',
