...
const CACHE_NAME = `${CACHE_PREFIX}v5.0.0-alpha.15-oxford-preview-20260913-2`;
...
const PRECACHE = [
  ...
  './js/v3-provider-runtime.js', './js/v3-groq-contracts.js', './js/v3-ai.js', './js/v5-version.js', './js/v5-suppression-runtime.js', './js/v5-mirror-runtime.js', './js/v5-mirror3.js', './js/v5-bridge.js', './js/v5-seed-migration.js',
