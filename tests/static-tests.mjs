...
assert.equal(pkg.version, '5.0.0-alpha.8');
assert.ok(index.includes('css/provider-runtime.css'));
assert.ok(index.includes('Vocabulary Index 5.0.0-alpha.8'));
...
assert.ok(sw.includes('v5.0.0-alpha.8-shell'));
...
for (const releaseDoc of ['README.md', 'DEPLOY.md', 'LOCAL_ARCHITECTURE.md', 'MIGRATION_5.0.0-alpha.8.md', 'RELEASE_5.0.0-alpha.8.md', 'TEST_REPORT_5.0.0-alpha.8.md']) {
  assert.ok(exists(releaseDoc), `alpha.8 release document missing: ${releaseDoc}`);
}
