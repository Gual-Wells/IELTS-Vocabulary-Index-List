...
const files = ['.nojekyll', 'index.html', 'manifest.webmanifest', 'sw.js'];
const directories = ['css', 'js', 'assets/icons', 'data/seed5-runtime', 'data/seed-baselines', 'integration/vix-function'];
