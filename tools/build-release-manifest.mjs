...
function excluded(relative) {
  ...
  return parts.includes('.git') || parts.includes('.wrangler') || parts.some((part) => part.startsWith('node_modules')) || parts.includes('dist')
    || parts.some((part) => part.startsWith('.tmp-'))
    ...
    || (!relative.includes('/') && (base.endsWith('.zip') || base.endsWith('.tar.gz')));
}
